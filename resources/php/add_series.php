...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO series (title, creator, release_year, genre, directors, actors, short_description, seasons, thumbnail) 
            VALUES ('$title', '$creator', '$release_year', '$genre', '$directors', '$actors', '$short_description', '$seasons', ";
